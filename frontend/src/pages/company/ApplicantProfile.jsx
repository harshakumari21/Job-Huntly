...
export default function ApplicantProfile() {
  ...
  const isFinalStatus = ['Hired', 'Declined'].includes(application?.stage || '');
              ...
              <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <label className="mt-4 block">
                  ...
                  <select
                    ...
                    className="mt-2 w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 outline-none disabled:cursor-not-allowed disabled:bg-slate-100"
                  >
                ...
                {isFinalStatus && (
                  <p className="mt-2 text-xs text-slate-500">This application is in a final status and cannot be changed.</p>
                )}
                ...
                <button
                  ...
                  disabled={saving || isFinalStatus || (status === application.stage && !isRescheduling)}

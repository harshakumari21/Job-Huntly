...
public class ApplicationController {
    ...
    public ResponseEntity<?> requestReschedule(@PathVariable Long id,
        ...
        try {
            ...
            String requestedDateRaw = body != null ? body.get("requestedDate") : null;
            ...
            String requestedDateText = requestedDateRaw != null && !requestedDateRaw.isBlank() ? requestedDateRaw : "unspecified";
            String text = user.getFullName() + " requested to reschedule the interview for " + job.getTitle() + ". Current time: " + interviewDate + ". Requested time: " + requestedDateText + ".";
            ...
            response.put("requestedDate", requestedDateRaw);
    ...
    public ResponseEntity<?> updateStatus(@PathVariable Long id,
        ...
        try {
            ...
            if (("Hired".equalsIgnoreCase(app.getStatus()) || "Declined".equalsIgnoreCase(app.getStatus()))
                    && nextStatus != null
                    && !app.getStatus().equalsIgnoreCase(nextStatus)) {
                return ResponseEntity.badRequest().body(Map.of("message", "Final application statuses cannot be changed."));
            }
